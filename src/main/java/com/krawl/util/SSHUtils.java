...
public class SSHUtils {
	 ...
	 *
	 * @param host
	 *            the hostname of the host you want to connect to
	 * @param port
	 ...
	 * 
	 * @param host
	 *            the hostname of the Client.The default port used for connection is
	 *            22
	 * @param username
	 *            the username required for authentication
	 * @param password
	 ...
	 * @param port
	 *            the port the user want to use for connection
	 * @param username
	 *            the username required for authentication
	 * @param password
	 *            the password required for authentication
	 ...
	 *
	 * @param host
	 *            the hostname of the client. The port number is by default 22
	 * @param username
	 *            the username required for authentication
	 * @param password
	 *            the password required for authentication
	 * @param localfilePath
	 *            the localfile path where the file is situated
	 * @param remotePath
	 *            the remote path where the file is going to be put
	 * @param fileName
	 *            the file name you want to put
	 * @throws IOException
	 *             Signals that an I/O exception has occurred.
	 */

	public static void putFileToRemoteHost(String host, String username, String password, String localfilePath,
	 ...
	 *            the hostname of the client
	 * @param port
	 *            the port number the user want to use for connection
	 * @param username
	 *            the username required for authentication
	 * @param password
	 *            the password required for authentication
	...
	public static void putFileToRemoteHost(String host, int port, String username, String password,
			String localfilePath, String remotePath, String fileName) throws IOException {
		...
		while (it.hasNext()) {
			if (it.next().getFilename().equals(fileName)) {
				LOGGER.info("The file " + fileName + " was tranferred successfully to " + remotePath);
				return;
			}
		}
		LOGGER.error("The file " + fileName + " was not tranferred  to " + remotePath);
	}
	 ...
	 *
	 * @param hostthe
	 *            hostname of the client. The port number is by default 22
	 * @param username
	 *            the username required for authentication
	 * @param password
	 *            the password required for authentication
	 * @param remoteFilePath
	 *            remotePath the remote path from where the file is going to be get
	 * @param localfilePath
	 *            the localfile path where the file is going to be put
	 * @param fileName
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
	public static void getFileFromRemoteHost(String host, String username, String password, String remoteFilePath,
	 ...
	 *            remotePath the remote path from where the file is going to be get
	 * @param localfilePath
	 *            the local file path where the file is going to be put
	 * @param fileName
	 *            the name of the file you want to transfer
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
	public static void getFileFromRemoteHost(String host, int port, String username, String password,
			String remoteFilePath, String localPath, String fileName) throws IOException {
		SftpClient sftp = getSftpClient(host, port, username, password);
		...
		if (!f.exists()) {
			LOGGER.error("The file " + fileName + " was not tranferred  to " + localPath);
		} else {
			LOGGER.info("The file " + fileName + " was tranferred successfully to " + localPath);
		}
	}
	 ...
	 *            the prefix
	 * @param fileLocation
	 *            the file location where the file is situated
	 * @param host
	 *            the host name of the server Default port number is 22
	 * @param username
	 *            the username required for authentication
	 * @param password
	 *            the password required for authentication
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
	public static String getServerFile(String prefix, String fileLocation, String host, String username,
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
	public static String getServerFile(String prefix, String fileLocation, String host, int port, String username,
			String password) throws IOException {
		SftpFile file;
		...
		LOGGER.info(fileNames.get(0));
		String outputFileName = fileNames.get(0);
		LOGGER.info("The output file is " + outputFileName);
		FileOutputStream fos = new FileOutputStream(outputFileName);
		try {
			LOGGER.info("Downloading the file: " + outputFileName);
			...
			try {
				...
				LOGGER.error("Cant do anything here... just ignore it");
			}
		}
	 ...
	 *            the password required for authentication
	 * @param cmd
	 *            the commands you want to execute remotely
	 * @return the string with the parameters you entered
	 * @throws IOException,
	 *             InterruptedException
	 */
	public static String executeCommand(String host, String username, String password, String cmd)
	 ...
	 *             InterruptedException
	 */
	public static String executeCommand(String host, int port, String username, String password, String cmd)
			throws IOException, InterruptedException {
	 ...
	 *             InterruptedException
	 */
	public static String executeCommands(String host, String username, String password, String[] cmds)
			throws IOException, InterruptedException {
	 ...
	 *             InterruptedException
	 */
	public static String executeCommands(String host, int port, String username, String password, String[] cmds)
			throws IOException, InterruptedException {
		...
		if (sessionChannel.executeCommand(cmdToExecute.toString())) {
			...
			LOGGER.error("The command did not execute");
			ssh.disconnect();
			return commandOutput;
		}
	}
